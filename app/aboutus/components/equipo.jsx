        ...
        <div class="font-[sans-serif] my-4">
            <div class="max-w-5xl max-lg:max-w-2xl mx-auto">
                <div class="max-w-2xl mx-auto text-center">
                    <h2 class="text-gray-800 text-4xl font-extrabold">Equipo</h2>
                ...
                <div class="grid lg:grid-cols-3 md:grid-cols-2 gap-8 max-md:justify-center mt-12">
                    <div class="border rounded-md overflow-hidden max-md:max-w-[300px]">
                        ...
                        <div class="p-4">
                            <h4 class="text-gray-800 text-base font-bold">Miguel Ortega</h4>
                    ...
                    <div class="border rounded-md overflow-hidden max-md:max-w-[300px]">
                        ...
                        <div class="p-4">
                            <h4 class="text-gray-800 text-base font-bold">Richard Herranz</h4>
                            <p class="text-gray-600 text-xs mt-1">Software Engineer</p>
                    ...
                    <div class="border rounded-md overflow-hidden max-md:max-w-[300px]">
                        ...
                        <div class="p-4">
                            <h4 class="text-gray-800 text-base font-bold">Jose Encalada</h4>
